/**
 * Типы для подразделения «Управление лидами»:
 * портальный пользователь (Директор/РОП), лид, облако, правило раздачи, менеджеры и партнёры по email.
 */
...
/** Партнёр, которому «водятся» лиды — задаётся по email ЛК */
